...
import call from "../../../../../assets/images/panel-security/icon-call-otp.svg";
...
import DeActivationCall from "./DeActivationCall";
import WarningAlert from "../../../../../common/element/modals/warning-alert/WarningAlert";
import ActivationCall from "./ActivationCall";
  ...
  return [
    <Row className="border-top-lightGray py-3 mx-0">
      <Col xs="12" sm="5" className="d-flex flex-row align-items-center">
        <img className="ml-4" src={call} alt="googleAuth" />
        <div>
          <h2 className="text-gray-4 size-3 mb-1">تماس صوتی</h2>
          <p className="fw-500 text-gray-2 size-5 mb-0 text-nowrap">
            ارسال کد تایید از طریق تماس صوتی
          </p>
        </div>
      </Col>
      ...
      {verifiedStatus ? (
        [
          ...
          >
            <img src={enableStatus ? checkedIcon : crossIcon} />
            <p
              className={`${
          ...
          >
            <CustomizedButton
              ...
              rightIcon={enableStatus && <BsX size={24} />}
              outlined
        ...
        <Col sm="6" className="d-flex justify-content-end mt-sm-0 mt-3">
          <p className="text-gray-2 size-4 mb-0">
            برای استفاده از سرویس ارسال کد تایید از طریق تماس صوتی باید از طریق
